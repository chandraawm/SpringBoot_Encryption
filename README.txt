...
5. Add the master-key.yml file  in linux server and refer in start up script to decrypt the password during start up of the spring boot application 
   The file name and location would be..
      
      * **/appl/config/master-key.yml** in service
